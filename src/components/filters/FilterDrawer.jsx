...
// Inner filter panel (shared between drawer and sidebar)
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-5 py-4 space-y-5">
        ...
        <div className="space-y-3">
          ...
          <NumberInput
            ...
            onChange={(v) => setFilter('valuationMin', v)}
            placeholder="0"
          />
          <NumberInput
            id="filter-val-max"
            ...
            onChange={(v) => setFilter('valuationMax', v)}
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-[#0a0a0a] border border-[#1f1f1f] rounded-lg px-3 py-2 text-sm text-white
                focus:outline-none focus:border-[#3a3a3a] transition-colors font-mono
                [color-scheme:dark]"
            />
          </div>
          <div className="space-y-1.5">
